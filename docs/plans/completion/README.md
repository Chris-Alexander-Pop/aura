...
| 7 | [offensive_security_phase2.md](offensive_security_phase2.md) | §2.17 offensive hardening, pentest UI | Medium |
| 8 | [greenfield_stubs_platform.md](greenfield_stubs_platform.md) | §3.9–3.11, §3.14, §4 | Small (mostly docs) |
...
3. **P4 offensive** — feature-gated, audit log, no default React exposure
