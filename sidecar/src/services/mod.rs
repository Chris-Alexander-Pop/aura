...
/// Runtime extra loaded from a local stdio binary (not part of the committed manifest).
...
impl ServiceRegistry {
    ...
    pub fn record_extension(&mut self, name: String, methods: usize) {
        self.extensions.push(LoadedExtension { name, methods });
    }
