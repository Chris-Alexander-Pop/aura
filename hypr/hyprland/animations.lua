...
hl.animation({ leaf = "layersOut", enabled = true, speed = 5, bezier = "emphasizedAccel", style = "slide" })
hl.animation({ leaf = "fadeLayers", enabled = true, speed = 2, bezier = "standard" })
hl.animation({ leaf = "fadeLayersIn", enabled = true, speed = 1.5, bezier = "standard" })
hl.animation({ leaf = "fadeLayersOut", enabled = true, speed = 1.5, bezier = "standard" })
